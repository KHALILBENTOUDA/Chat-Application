        ...
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          <div className="w-full bg-white rounded-3xl shadow dark:border md:mt-0 sm:max-w-md xl:p-0 ">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8 ">
              ...
              <form
                className="space-y-4 md:space-y-6 pt-8 max-md:pt-2"
                action=""
                onSubmit={handleSubmit}
              >
                {status === "success" ? (
                  <h1
                    className={`  text-green-400 bg-green-100 w-full mt-5 pl-6 text-[11px] ${
                      errorMessage ? "pl-7 py-2" : "null"
                    }  max-md:text-[10px]   rounded-3xl `}
                  >
                    {errorMessage}
                  </h1>
                ) : (
                  <h1
                    className={`text-red-400 bg-red-100 w-full mt-5 pl-6 text-[11px] ${
                      errorMessage ? "pl-7 py-2" : "null"
                    } max-md:text-[10px] rounded-3xl`}
                  >
                ...
                {inputs.map((inp) => {
                  return (
                    <>
                      <div>
                        <label className="block mb-2 max-md:mb-1 ml-1  text-sm font-bold  text-gray-500 max-md:text-[12px]">
                          {inp.lable}
                        </label>
                        <input
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-sm font-medium text-lgrn hover:underline dark:text-primary-500 max-md:text-[10px]"
                  >
                    Forgot password?
                  </Link>
                </div>
                <button
                  type="submit"
                  className="flex items-center justify-center mt-4 bg-lgrn text-white rounded-full w-full h-9  max-md:h-8 max-md:text-sm shadow-md drop-shadow-md  hover:bg-grn transition duration-300"
                >
                  {loading ? (
                    <div
                ...
                <p className="text-sm  max-sm:text-[10px]  font-light text-gray-500 dark:text-gray-400">
                  ...
                  <Link
                    to="/auth/register"
                    className="font-medium text-lgrn hover:underline dark:text-primary-500 pl-1"
                  >
                    Create an account
                  </Link>
                </p>
