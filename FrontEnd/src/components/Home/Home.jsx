...
const Homep = () => {
  return (
   <section className=' container  mx-auto  text-center bg-white  h-[80vh] max-sm:h-[65vh] relative  '>
      ...
      <div className="w-[60%] mx-auto font-PlusJakartaSans-VariableFont_wght  max-sm:w-full max-md:w-[80%] max-lg:w-[80%] relative">
                        ...
                        <h1 className='py-8 max-md:py-4 font-bold text-black text-[50px] xs:bg-blue-400 max-sm:text-[24px] max-sm:w-[360px] mx-auto sm:text-[32px]  md:text-[38px] lg:text-[40px]  max-lg:text-[40px] xl:text-[50px] '> Matcha Your <span className='bg-gradient-to-r from-ble  via-slate-100  to-lgrn bg-clip-text text-transparent'> Gateway</span> to Seamless Online Conversation and Meetings 🌟</h1>
